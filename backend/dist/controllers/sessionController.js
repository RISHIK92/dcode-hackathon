 ...
 * @access  Private
 */
export const runProjectSession = async (req, res) => {
    ...
    try {
        ...
        const containerId = await containerManager.startContainer(userId, projectId, project.files);
 ...
 * @access  Private
 */
export const stopProjectSession = async (req, res) => {
